...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">教练预约管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>教练预约列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>可约时间</label>
					<input type="text" id="shijianduanSearch" class="form-control form-control-sm" placeholder="请输入可约时间" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>姓名</label>
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('每日预约人数统计')"><i class="fa fa-database"></i><span>每日预约人数统计</span></button>
			</div>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('minge')">预约名额<i id="mingeIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('shenqingriqi')">申请日期<i id="shenqingriqiIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('shenqingbeizhu')">申请备注<i id="shenqingbeizhuIcon" class="fa fa-sort"></i></th>
            ...
            <div class="openBox" v-if="showType1">
                ...
                <div class="openView">
                    <div id="shenqingriqiMain1" class="graph" style="width: 70vw;height:50vh;"></div>
                </div>
            </div>
		</div>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shenqingbeizhuCell  = document.createElement('td');
						 ...
						 shenqingbeizhuCell.innerHTML = item.shenqingbeizhu;

			row.appendChild(shenqingbeizhuCell);
		...
		function sh(){
			...
			httpJson("jiaolianyuyue/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiaolianyuyue/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jiaolianyuyue");
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('shenqingriqiMain1'),'macarons');
                                    var option = {};
                                    option = {
                                        title: {
                                            text: '每日预约人数统计',
