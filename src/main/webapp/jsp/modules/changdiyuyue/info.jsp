		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="changdimingcheng" name="changdimingcheng" class="form-control" v-model="ruleForm.changdimingcheng" readonly>
				</div>
				<div class="form-item">
					<label>场地类型</label>

					<input id="changdileixing" name="changdileixing" class="form-control" v-model="ruleForm.changdileixing" readonly>
				</div>
				<div class="form-item">
					<label>时间段</label>
				...
				<div class="form-item">
					...
					<input id="changdidaxiao" name="changdidaxiao" class="form-control" v-model="ruleForm.changdidaxiao" readonly>
				</div>
				<div class="form-item">
					<label>场地地址</label>

					<input id="changdidizhi" name="changdidizhi" class="form-control" v-model="ruleForm.changdidizhi" readonly>
				</div>
				<div class="form-item">
					<label>申请时间</label>
				...
				<div class="form-item-file">
					<label>申请备注</label>
					<script id="shenqingbeizhuEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.shenqingbeizhu != null && ruleForm.shenqingbeizhu != 'null' && ruleForm.shenqingbeizhu != ''){
				var mes = '' + ruleForm.shenqingbeizhu;
				var shenqingbeizhuUeditor = UE.getEditor('shenqingbeizhuEditor');
				shenqingbeizhuUeditor.ready(function() {
					shenqingbeizhuUeditor.setContent(mes);
					shenqingbeizhuUeditor.setDisabled('fullscreen');
				});
			}
