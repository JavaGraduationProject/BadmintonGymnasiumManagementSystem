...
<body>
	<div id="main-container">
		...
		<div id="center-container">
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('商品库存统计')"><i class="fa fa-database"></i><span>商品库存统计</span></button>
			</div>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'shangpindingdan','','','')");
